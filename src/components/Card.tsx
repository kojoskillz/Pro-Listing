...
<div className="mb-20">
    ...
    <div className="gap-20 gap-y-5  lg:gap-y-10 grid -mt-[2rem] lg:-mt-[2rem] lg:m-[16rem] lg:grid-cols-2 md:grid">
    ...
    >
      <span className="pointer-events-none mr-auto  whitespace-pre-wrap bg-gradient-to-b from-black to-gray-300/80 bg-clip-text agdasima text-9xl font-semibold leading-none dark:from-white dark:to-slate-100/10">
        100+
      </span>
