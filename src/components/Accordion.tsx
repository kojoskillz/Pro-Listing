    ...
    return (
      <Accordion type="single" collapsible className="mb-20 w-[22rem] md:w-[50rem] lg:w-[60rem] m-auto ">
        <AccordionItem value="item-1">
          <AccordionTrigger className="text-[16px] lg:text-4xl md:text-[20px]  ">What services does your agency provide?</AccordionTrigger>
          <AccordionContent className="text-[11.5px] lg:text-[17px] md:text-[14px] font-normal text-wrap text-gray-300  ">
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger className="text-[16px] lg:text-4xl md:text-[20px]  ">How long does the token listing process take?</AccordionTrigger>
          <AccordionContent className="text-[11.5px] lg:text-[17px] md:text-[14px] font-normal text-wrap text-gray-300  ">
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger className="text-[16px] lg:text-4xl md:text-[20px]  ">Do you list tokens with low volume?</AccordionTrigger>
          <AccordionContent className="text-[11.5px] lg:text-[17px] md:text-[14px] font-normal text-wrap text-gray-300  ">
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger className="text-[16px] lg:text-4xl md:text-[20px]  "> What are your pricing structures?</AccordionTrigger>
          <AccordionContent className="text-[11.5px] lg:text-[17px] md:text-[14px] font-normal text-wrap text-gray-300  ">
        ...
        <AccordionItem value="item-5">
          <AccordionTrigger className="text-[16px] lg:text-4xl md:text-[20px]  "> Will I receive a detailed breakdown of costs?</AccordionTrigger>
          <AccordionContent className="text-[11.5px] lg:text-[17px] md:text-[14px] font-normal text-wrap text-gray-300  ">
        ...
        <AccordionItem value="item-7">
          <AccordionTrigger className="text-[16px] lg:text-4xl md:text-[20px]  ">Are there any hidden fees?</AccordionTrigger>
          <AccordionContent className="text-[11.5px] lg:text-[17px] md:text-[14px] font-normal text-wrap text-gray-300  ">
          No, we pride ourselves on transparent pricing with no additional hidden fees.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-8">
          <AccordionTrigger className="text-[16px] lg:text-4xl md:text-[20px]  "> What factors influence the cost of my project?</AccordionTrigger>
          <AccordionContent className="text-[11.5px] lg:text-[17px] md:text-[14px] font-normal text-wrap text-gray-300  ">
          The cost will depend on the specific services, scope, complexity, and duration of your project.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-9">
          <AccordionTrigger className="text-[16px] lg:text-4xl md:text-[20px]  ">Do you offer package deals or discounts?</AccordionTrigger>
          <AccordionContent className="text-[11.5px] lg:text-[17px] md:text-[14px] font-normal text-wrap text-gray-300  ">
